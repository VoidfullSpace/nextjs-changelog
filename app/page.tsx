...
const updates = [
  {
    ...
    description: [
      {
        id: "meeting-intro",
        content: "Too often, notes get scattered (or forgotten).",
      },
      {
        id: "meeting-sidebar",
        content: (
          <>
            The new Meetings tab in your sidebar organizes notes from every
            meeting you’ve run or joined.
            <br />
            It syncs with your calendar so you can easily prep notes, join calls
            and use AI Meeting Notes
            <br />
      ...
      },
      {
        ...
        content: (
          <>
            Just type <span className="font-semibold text-gray-600">/meet</span>{" "}
  ...
  },
  {
    ...
    description: [
      ...
      },
      {
        ...
        content: (
          <>
            Connect any database with dates to Calendar, then create, schedule,
            and complete tasks in
            <br />
      ...
      {
        id: "task-guide",
        content: "Here's a quick guide to get started. Try it out now!",
      },
    ],
