...
export function Header() {
    ...
    return (
        <header className="border-b border-gray-200">
            <div className={clsx('px-4 sm:px-6 lg:px-12 py-3', 'flex items-center justify-between')}>
                <div>
                ...
                <ul className="list-none text-sm sm:text-base">
                    <li>
                        <a
                            ...
                            href={"https://voidfull.com?utm_source=blog&utm_medium=navbar&utm_content=go_to_homepage"}
